...
* You can use the file ***tools.txt*** to install the necessary tools and configure the APIs:
  * naabu, waybackurls, hakrawler, linkFinder, arjun, eyewitness, XSStrike, dalfox, ffuf, gau, kxss, paramspider, hinject, colorized-logs, github-search, screen, curl, zile, smuggler and DSSS.
