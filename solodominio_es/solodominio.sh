...
if [[ -z $1 ]]; then
	...
	mkdir -p ${MIDIR}/${DOMINIO}/aquatone
	...
	funcion_merge () {
		...
		sort ${MIDIR}/${DOMINIO}/${DOMINIO}_ultimo.txt | uniq >> ${MIDIR}/${DOMINIO}/${DOMINIO}_final.txt
	}
