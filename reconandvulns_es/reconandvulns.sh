...
if [[ -z $1 ]]; then
	...
	DIRBLISTA=~/tools/listas/directory-list-2.3-medium.txt
	...
	funcion_dirb () {
		...
		### dirb ###
		cd ${MIDIR}/${DOMINIO}/dirb
		screen -A -m -d -S screen_dirb_$DOMINIO dirb ${WEB} ${DIRBLISTA} -z 2000 -w -o dirb_${DOMINIO}.txt
